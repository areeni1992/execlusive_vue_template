  ...
  >
    ...
    <div class="flex flex-wrap items-center gap-x-4 gap-y-2">
      <p class="text-sm/6 text-white">
        <strong class="font-semibold text-white">GeneriCon 2023</strong
        ><svg
          viewBox="0 0 2 2"
          class="mx-2 inline size-0.5 fill-white text-white"
          aria-hidden="true"
        >
      ...
      <router-link
        ...
        >Register now <span aria-hidden="true">&rarr;</span></router-link
      >
    </div>
