                ...
                >
                  ...
                  <div class="sm:col-span-8 lg:col-span-7">
                    <h2 class="text-2xl font-bold text-gray-900 sm:pr-12">
                      <slot :name="props.product.name"></slot>
                    </h2>
                    ...
                    <section aria-labelledby="information-heading" class="mt-2">
                      ...
                      <p class="text-2xl text-gray-900">
                        <slot :name="props.product.price"></slot>
                      </p>
                      ...
                      <div class="mt-6">
                        ...
                        <div class="flex items-center">
                          ...
                          <a
                            ...
                            >{{ props.product.reviews }} reviews</a
                          >
                        </div>
                      </div>
                    </section>
                    ...
                    <section aria-labelledby="options-heading" class="mt-10">
                      ...
                      <form>
                          ...
                          <div class="mt-4 flex items-center gap-x-3">
                            ...
                            >
                              <input
                                ...
                                name="color"
                                :value="color.id"
                                :checked="color === props.product.colors[0]"
                                :class="[
                                  color.classes,
                        ...
                        <fieldset class="mt-10" aria-label="Choose a size">
                          ...
                          <div class="mt-2 grid grid-cols-4 gap-3">
                            <label
                              ...
                              class="group relative flex items-center justify-center rounded-md border border-gray-300 bg-white p-3 has-checked:border-amber-600 has-checked:bg-red-700 has-focus-visible:outline-2 has-focus-visible:outline-offset-2 has-focus-visible:outline-indigo-600 has-disabled:border-gray-400 has-disabled:bg-gray-200 has-disabled:opacity-25"
                            >
                              <input
                                type="radio"
                                name="size"
                                :value="size.id"
                                :checked="size === props.product.sizes[2]"
                        ...
                        <button
                          type="submit"
                          class="mt-6 flex w-full items-center justify-center rounded-md border border-transparent bg-red-600 px-8 py-3 text-base font-medium text-white hover:bg-red-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-hidden"
                        >
                          Add to bag
                        </button>
                      </form>
